      ...
      <div class="login-box-body">
        ...
        <form action="<?php echo base_url(); ?>resetPasswordUser" method="post">
          <div class="form-group has-feedback">
            <input type="email" class="form-control" placeholder="电子邮件" name="login_email" required />
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
              <input type="submit" class="btn btn-primary btn-block btn-flat" value="提交" />
            </div><!-- /.col -->
          </div>
        </form>
        <a href="<?php echo base_url() ?>">登录</a><br>
      </div><!-- /.login-box-body -->
    </div><!-- /.login-box -->
